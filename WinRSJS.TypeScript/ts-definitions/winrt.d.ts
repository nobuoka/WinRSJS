...
declare module Windows {
    export module ApplicationModel {
        export module Activation {
            ...
            /** Windows Phone only. */
            export interface IContinuationActivatedEventArgs extends Windows.ApplicationModel.Activation.IActivatedEventArgs {
                /** Read-only. */
                continuationData: Windows.Foundation.Collections.ValueSet;
            }
            /** Windows Phone only. */
            export interface IWebAuthenticationBrokerContinuationEventArgs extends Windows.ApplicationModel.Activation.IContinuationActivatedEventArgs, Windows.ApplicationModel.Activation.IActivatedEventArgs {
                /** Read-only. */
    ...
    export module UI {
        export module WebUI {
            ...
            export class WebUIApplication {
                ...
                static removeEventListener: { (type: string, listener: Function, capture: boolean): void };
            }
        }
    }
}
 ...
 */
declare module Windows.Web.Http { // TODO: Not completed.
    /**
