...
interface DetailedCustomEvent<T> extends CustomEvent {
    detail: T;
}
...
declare module WinJS.Application {
    interface PromiseSettableCustomEvent<T> extends CustomEvent {
        detail: T;
    ...
    **/
    ...
    /**
     * Adds an event listener for application-level events: activated.
    ...
    **/
    function addEventListener(type: "activated", listener: { (evt: PromiseSettableCustomEvent<Windows.ApplicationModel.Activation.IActivatedEventArgs>): void; }, capture?: boolean): void;
    /**
...
declare module WinJS.Binding {
    ...
    **/
    ...
    interface ListBaseEventInfo<T> extends DetailedCustomEvent<{ index: number; key: string; value: T; }> {
    }
    ...
    **/
    class ListBase<T> {
        ...
        **/
        ...
        addEventListener(type: "iteminserted", listener: (evt: ListBaseEventInfo<T>) => void, useCapture?: boolean): void;
        addEventListener(type: "itemremoved", listener: (evt: ListBaseEventInfo<T>) => void, useCapture?: boolean): void;
...
declare module WinJS {
    ...
    **/
    class Promise<T> implements IPromise<T> {
        ...
        **/
        static join<T>(values: { [key: string]: IPromise<T>|T }): IPromise<{ [key: string]: T }>;
         ...
         * @returns A Promise whose value is an object with the same field names as those of the object in the values parameter, where each field value is the fulfilled value of a promise.
        **/
        static join(values: { [key: string]: any }): IPromise<any>;
        /**
         * Creates a Promise that is fulfilled when all the values are fulfilled.
         * @param values An object whose members contain values, some of which may be promises.
         * @returns A Promise whose value is an object with the same field names as those of the object in the values parameter, where each field value is the fulfilled value of a promise.
        **/
        static join<T>(values: (IPromise<T>|T)[]): IPromise<T[]>;
        /**
         * Creates a Promise that is fulfilled when all the values are fulfilled.
         * @param values An object whose members contain values, some of which may be promises.
         * @returns A Promise whose value is an object with the same field names as those of the object in the values parameter, where each field value is the fulfilled value of a promise.
...
declare module WinJS.UI.Pages {
    ...
    **/
    interface IPageControlMembers {
        ...
        **/
         ...
         * @param options An object that contains one or more property/value pairs to apply to the PageControl. How these property/value pairs are used (or not used) depends on the implementation of that particular PageControl.
         * @param loadResult The elements returned from the load method.
        **/
        render? (element: HTMLElement, options: any, loadResult: HTMLElement): void;

        //#endregion Methods

    }

    interface AbstractPageControl extends IPageControlMembers {
        element: HTMLElement;
        elementReady: WinJS.Promise<HTMLElement>;
        uri: string;
        selfhost: boolean;
        dispose(): void;
    }
    interface AbstractPageControlConstructor {
        new (element?: HTMLElement, options?: any, complete?: (page: any) => void, parentedPromise?: WinJS.Promise<any>): AbstractPageControl;
        prototype: AbstractPageControl;
    }
    ...
    **/
    function define(uri: string, members: IPageControlMembers): AbstractPageControlConstructor;
